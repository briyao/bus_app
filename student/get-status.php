...
Date: 6/11/19
Task Description: Returns student’s status from “students” table to display in stop info card
-->
*/
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    //get status
    $query_string = "SELECT going FROM students WHERE student_id=".$_GET['student_id'].";";
