...
Date: 6/11/19
Task Description: Starts login session for student, includes elements for entering username and password, handles incorrect login info
*/
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($error)){
        $query = "SELECT student_id, password FROM students WHERE username = '$username';";
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <i class="material-icons icon-button">school</i>
