...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $query_string = "INSERT INTO drivers (name, username, password) VALUES ('".$_POST["name"]."','".$username."','".$hashed_password."');";
  ...
  // 2) get driver_id of latest driver by username
  $query_string_2 = "SELECT driver_id FROM drivers WHERE username = '".$username."' AND password = '".$hashed_password."';";
  ...
  $query_string_3 = "INSERT INTO driverpws (driver_id, real_password) VALUES ('".$driver_id."','".$real_password."');";
